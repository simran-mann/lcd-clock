...
#define XPT2046_SPI1_MOSI_GPIO_Port 		GPIOA
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    // SCK (PB13)
    GPIO_InitStruct.Pin = XPT2046_SPI1_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    HAL_GPIO_Init(XPT2046_SPI1_SCK_GPIO_Port, &GPIO_InitStruct);

    // MOSI (PB15)
    GPIO_InitStruct.Pin = XPT2046_SPI1_MOSI_Pin;
    HAL_GPIO_Init(XPT2046_SPI1_MOSI_GPIO_Port, &GPIO_InitStruct);

    // MISO (PC2)
    GPIO_InitStruct.Pin = XPT2046_SPI1_MISO_Pin;
    HAL_GPIO_Init(XPT2046_SPI1_MISO_GPIO_Port, &GPIO_InitStruct);
