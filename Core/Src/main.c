  ...
  /* USER CODE BEGIN WHILE */
    ...
    /* USER CODE BEGIN 3 */
		...
		if (HAL_GetTick() - millis_2 >= 1000UL) {
			Clock_update_current_time(&ClockUI_inst.clock_inst);
			ClockUI_update_current_time(&ClockUI_inst);
//			if (Clock_is_alarm(&ClockAlarmUI_inst.clock_inst) && ClockUI_inst.clock_inst.alarm_status == ALARM_ON) {
